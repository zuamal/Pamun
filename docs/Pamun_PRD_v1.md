...
| FR-3.7 | Semantic Zoom: 줌 레벨에 따라 노드와 Edge의 렌더링 디테일을 조절한다. (1) 줌 < 0.6 — 노드: 색상 도트 + ID 라벨만, Edge: 색상만(두께·점선 구분 제거). (2) 줌 0.6–1.2 — 노드: 라벨 + 제목 1줄, Edge: 실선/점선 구분 유지. (3) 줌 > 1.2 — 노드: 라벨 + 제목 2줄 + 연결 수 뱃지. 임계값(0.6 / 1.2)은 구현 중 미세 조정 가능. |
